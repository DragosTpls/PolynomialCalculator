...
public class PolyInterpreter implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(command.equals("ok1"))  {
        	...
        	panel.controlLabel.setText("<html><p style='font-family:Arial;font-weight:100;line-height:15px;'>Rezultat polinom 1: <b>" + poli.valoare() + "</b></p></html>");
        	...
        	Polinom poli =  this.createPoli(buffer);
        	panel.controlLabel2.setText("<html><p style='font-family:Arial;font-weight:100;line-height:15px;'>Rezultat polinom 2: <b>" + poli.valoare() + "</b></p></html>");
        	...
        	panel.controlLabel3.setText("<html><p style='font-family:Arial;font-weight:100;line-height:15px;'>Rezultat suma polinoame: <b>"+ poli3.valoare() + "</b></p></html>");
        	...
        	panel.controlLabel4.setText("<html><p style='font-family:Arial;font-weight:100;line-height:15px;'>Rezultat scadere polinoame: <b>"+ poli3.valoare() + "</b></p></html>");
        	...
        	panel.controlLabel5.setText("<html><p style='font-family:Arial;font-weight:100;line-height:15px;'>Rezultat inmultire polinoame: <b>"+ poli3.valoare() + "</b></p></html>");
            ...
            panel.controlLabel6.setText("<html><p style='font-family:Arial;font-weight:100;line-height:15px;'>Rezultat impartire polinoame: <b>" + polis.get(0).valoare() + "   |   " + polis.get(1).valoare() + "</b></p></html>");
            panel.statusLabel6.setText("<html><p style='font-family:Arial;font-weight:100;line-height:15px;'>Polinom 6: <b>" + polis.get(0).afisare() + "  |   " + polis.get(1).afisare() + "</b></p></html>");
         }
    }
